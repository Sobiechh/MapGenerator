...
//     const group = useRef()
//     const { nodes, materials } = useGLTF("models/fela.glb")
//     console.log(nodes)
//     return (
//       <group ref={group} {...props} dispose={null} scale={[0.03,0.03,0.03]} rotation={[0,0,20]}>
//         <mesh 
...
export default function Tree(props) {
    ...
    return (
        <group ref={group} {...props} dispose={null} scale={[0.0003, 0.0003, 0.0003]}>
            <group rotation={[-Math.PI / 2, 0, 0]}>
                <group rotation={[Math.PI / 2, 0, 0]}>
                    
                <group position={[-234.43, 1.69, 272.22]} rotation={[0, -1.17, 0]}>
                        <group position={[32.88, 213, -2.06]} rotation={[2.92, -0.02, 3.14]}>
                            <mesh material={materials.leaf1} geometry={nodes.leafplanes_2_196_0_2_leaf1_0.geometry} />
                        </group>
                        <group position={[15.31, 370.64, -34.74]} rotation={[-0.39, 0.94, 0.32]}>
...
//-------------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------
{/* <group position={[-25.71, 289.16, -91.79]}>
...
//-------------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------
{/* <group position={[21.86, 162.29, 54.25]} rotation={[-2.82, -0.66, -2.94]}>
